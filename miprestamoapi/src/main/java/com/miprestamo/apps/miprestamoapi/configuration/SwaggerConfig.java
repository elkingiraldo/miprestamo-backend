package com.miprestamo.apps.miprestamoapi.configuration;
...
public class SwaggerConfig {
	...
	public static final ApiInfo DEFAULT = new ApiInfo("Api Documentation for Mi Prestamo API",
			"This module is in charge of managing all clients and their commitments for Mi Prestamo app", "1.0",
			"urn:tos", DEFAULT_CONTACT, "Elkin Giraldo rights reserved", "elkin.giraldo.pinedo@gmail.com",
